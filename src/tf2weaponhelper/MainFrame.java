...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initStatDatabase(){
        ...
        stats.add(new WeaponStat(101, true, "Projectile range increased", "+%s1% projectile range", "percentage"));
        stats.add(new WeaponStat(102, false, "Projectile range decreased", "%s1% projectile range", "percentage"));
        stats.add(new WeaponStat(103, true, "Projectile speed increased", "+%s1% projectile speed", "percentage"));
        stats.add(new WeaponStat(104, false, "Projectile speed decreased", "%s1% projectile speed", "percentage"));
        stats.add(new WeaponStat(105, false, "overheal penalty", "%s1% max overheal", "inverted_percentage"));
        stats.add(new WeaponStat(106, true, "weapon spread bonus", "%s1% more accurate", "inverted_percentage"));
        stats.add(new WeaponStat(107, true, "move speed bonus", "+%s1% faster move speed on wearer", "percentage"));
        stats.add(new WeaponStat(108, true, "health from packs increased", "+%s1% health from packs on wearer", "percentage"));
        stats.add(new WeaponStat(109, false, "health from packs decreased", "%s1% health from packs on wearer", "percentage"));
        stats.add(new WeaponStat(110, true, "heal on hit for slowfire", "On Hit: Gain up to +%s1 health", "additive"));
        
        stats.add(new WeaponStat(111, false, "selfdmg on hit for slowfire", "On Hit: %s1 health", "additive"));
        stats.add(new WeaponStat(112, true, "ammo regen", "+%s1% ammo regenerated every 5 seconds on wearer", "additive_percentage"));
        stats.add(new WeaponStat(113, true, "metal regen", "+%s1 metal regenerated every 5 seconds on wearer", "additive"));
        stats.add(new WeaponStat(114, true, "mod mini-crit airborne", "Mini-crits targets launched airborne", "constant"));
        stats.add(new WeaponStat(115, true, "mod shovel damage boost", "Damage increases as the user becomes injured", "constant"));
        stats.add(new WeaponStat(118, true, "dmg falloff decreased", "%s1% splash damage fall off", "percentage"));
        stats.add(new WeaponStat(119, true, "sticky detonate mode", "Detonates stickybombs near the crosshair and directly under your feet", "constant"));
        stats.add(new WeaponStat(120, false, "sticky arm time penalty", "%s1 sec slower bomb arm time", "additive"));
        
        stats.add(new WeaponStat(121, true, "stickies detonate stickies", "Able to destroy enemy stickybombs", "constant"));
        stats.add(new WeaponStat(123, true, "speed boost when active", "%s1% speed boost while active weapon", "percentage"));
        stats.add(new WeaponStat(124, false, "mod wrench builds minisentry", "Replaces the Sentry with a Mini-Sentry", "constant"));
        stats.add(new WeaponStat(125, false, "max health additive penalty", "%s1 max health on wearer", "additive"));
        stats.add(new WeaponStat(126, true, "sticky arm time bonus", "%s1 sec faster bomb arm time", "additive"));
        stats.add(new WeaponStat(127, false, "sticky air burst mode", "Launched bombs shatter on surfaces", "constant"));
        stats.add(new WeaponStat(129, false, "health drain", "%s1 health drained per second on wearer", "additive"));
        stats.add(new WeaponStat(130, true, "medic regen bonus", "+%s1% natural regen rate", "percentage"));
        
        stats.add(new WeaponStat(131, false, "medic regen penalty", "-%s1% natural regen rate", "percentage"));
        stats.add(new WeaponStat(134, true, "attach particle effect", "★ Unusual Effect: %s1", "particle_index"));
        stats.add(new WeaponStat(135, true, "rocket jump damage reduction", "%s1% blast damage from rocket jumps", "percentage"));
        stats.add(new WeaponStat(136, true, "mod sentry killed revenge", "Frontier Justice revenge crits", "constant"));
        stats.add(new WeaponStat(137, true, "dmg bonus vs buildings", "+%s1% damage vs buildings", "percentage"));
        stats.add(new WeaponStat(138, false, "dmg penalty vs players", "%s1% damage vs players", "percentage"));
        stats.add(new WeaponStat(139, true, "lunchbox adds maxhealth bonus", "Adds +50 max health for 30 seconds", "constant"));
        
        stats.add(new WeaponStat(141, true, "selfmade description", "I made this!", "percentage"));
        stats.add(new WeaponStat(146, true, "damage applies to sappers", "Damage removes Sappers", "constant"));
        stats.add(new WeaponStat(147, true, "Wrench index", "Wrench no. %s1", "additive"));
